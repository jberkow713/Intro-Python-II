...
print("Ages plus 10:")
K = [39, 42, 47, 40, 36, 28, 52, 22, 51, 41]


# adding K to each element 
d = [(i.age + 10) for i in humans]
print(d)
#e = [x for x in humans if (x.age[0])+1 ]
#f = [x for x in humans if x.age in range(26, 33)]
...
f = [x for x in humans if x.age in range(27, 33)]
